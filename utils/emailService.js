            ...
            <table width="600" cellpadding="0" cellspacing="0" style="background:#fff;border-radius:16px;overflow:hidden;box-shadow:0 4px 6px rgba(0,0,0,.1);">
                    ...
                    <tr>
                      <td align="center" style="padding:20px 0;">
                        <a href="${verificationLink}"
                           style="display:inline-block;background:linear-gradient(135deg,#0B84FF,#0073E6);color:#fff;text-decoration:none;padding:16px 40px;border-radius:12px;font-size:16px;font-weight:600;box-shadow:0 4px 12px rgba(11,132,255,.3);">
              ...
              <tr>
                <td style="background:#F8FAFC;padding:30px;text-align:center;border-top:1px solid #E2E8F0;">
                  <p style="margin:0;color:#94A3B8;font-size:13px;">AttendSure Portal © 2025 — This is an automated email. Please do not reply.</p>
                </td>
              </tr>
            </table>
          </td></tr>
